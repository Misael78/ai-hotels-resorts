  ...
  protected static function checkCdnExceptions(ProviderInterface $provider, $reset = TRUE) {
    ...
    if ($exceptions) {
      ...
      foreach ($exceptions as $exception) {
        DeprecationHelper::backwardsCompatibleCall(\Drupal::VERSION, '10.1.0', fn() => Error::logException(\Drupal::logger('bootstrap3'), $exception), fn() => watchdog_exception('bootstrap3', $exception));
      }
    }
    return !!$exceptions;
  }
